...
(function ($) {
	...
	function Wysiwyg() {
		...
		this.defaults = {
			...
			debug: false,
			controls: {},
			css: '/stylesheets/wysiwyg.editor.css',
			events: {},
			autoGrow: false,
			autoSave: true,
			...
			iFrameClass: null,
			initialContent: "",
			treatInitialContentAsPlaceholder: false,
		...
		this.ui.initFrame = function () {
			...
			$(self.editorDoc).bind("click.wysiwyg", function (event) {
				if (self.options.treatInitialContentAsPlaceholder) {
				  if (self.getContent() == self.options.initialContent) {
            self.setContent(" ");
				  }
				}
		...
		this.saveContent = function () {
			if (this.original) {
				...
				if (this.options.treatInitialContentAsPlaceholder) {
				  if (content == this.options.initialContent) {
				    content = "";
				  }
				}
